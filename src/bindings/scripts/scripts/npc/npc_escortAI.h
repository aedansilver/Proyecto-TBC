...
struct TRINITY_DLL_DECL npc_escortAI : public ScriptedAI
{
    public:
        ...
        //EnterEvadeMode() override helpers
        void SetIsBeingEscorted(bool IsEscorted) { IsBeingEscorted = IsEscorted; }
        bool GetIsBeingEscorted() { return IsBeingEscorted; }
        void SetIsReturning(bool isreturning) { Returning = isreturning; }
        bool GetIsReturning() { return Returning; }
