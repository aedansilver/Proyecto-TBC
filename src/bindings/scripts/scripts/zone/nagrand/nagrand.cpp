...
#define GOSSIP_HL "Ich will Antworten, Oger!"
#define GOSSIP_SL1 "Warum sind die Felsfäuste so weit hier draußen? Ihr wisst, dass dies hier Territorium der Kurenai ist."
#define GOSSIP_SL2 "Und Ihr denkt, Ihr könntet alles essen was Ihr wollt? Ihr versucht offensichtlich, die Zerschlagenen von Telaar zu essen."
#define GOSSIP_SL3 "Das bedeutet Krieg, Brocken! Krieg, sage ich!"
...
#define GOSSIP_HATS1 "Ich sehe verbogenen Stahl und rieche zerrissene Erde..."
#define GOSSIP_HATS2 "Nun...?"
#define GOSSIP_HATS3 "[PH] Story about Illidan's Pupil"

#define GOSSIP_SATS1 "Legion?"
#define GOSSIP_SATS2 "Und nun?"
#define GOSSIP_SATS3 "Wie seht Ihr sie jetzt?"
#define GOSSIP_SATS4 "Konstruktionslager?"
#define GOSSIP_SATS5 "Ok."
#define GOSSIP_SATS6 "Geschichte erzählt"
...
#define GOSSIP_HLB "Ich habe viele Eurer Ogers getötet, Lantresor. Ich habe keine Furcht."
#define GOSSIP_SLB1 "Sollte ich das? Für mich seht Ihr wie ein Orc aus."
#define GOSSIP_SLB2 "Und die andere Hälfte?"
#define GOSSIP_SLB3 "Ich habe von Eurer Art gehört, aber ich hätte nie geglaubt, den Tag zu erleben, an dem ich ein Halbblut treffe."
#define GOSSIP_SLB4 "Ich bitte um Verzeihung, ich wollte Euch nicht beleidigen. Ich bin hier im Auftrag meines Volkes."
#define GOSSIP_SLB5 "Mein Volk verlangt, dass Ihr Eure Oger der Felsfäuste zurückzieht und alle Angriffe auf unsere Gebiete unterlasst. Im Gegenzug werden wir unsere Streitkräfte ebenfalls zurückziehen."
#define GOSSIP_SLB6 "Dann werden wir Euch bis zum Ende bekämpfen, Lantresor. Wir werden nicht tatenlos zusehen, wie ihr unsere Städte plündert und unsere Leute tötet."
#define GOSSIP_SLB7 "Was muss ich machen?"
