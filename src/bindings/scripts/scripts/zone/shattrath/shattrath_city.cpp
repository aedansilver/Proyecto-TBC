...
#define GOSSIP_HZ "Bringt mich zu den Höhlen der Zeit."
...
#define GOSSIP_BOOK "Ezekiel sagte, Ihr hättet da ein bestimmtes Buch..."
...
#define ISANAH_GOSSIP_1 "Wer sind die Sha'tar?"
#define ISANAH_GOSSIP_2 "Ist Shattrath nicht eine Draeneistadt? Warum lasst Ihr dann auch andere hier zu?"
...
#define KHADGAR_GOSSIP_3    "Ich verstehe." //6th too this
