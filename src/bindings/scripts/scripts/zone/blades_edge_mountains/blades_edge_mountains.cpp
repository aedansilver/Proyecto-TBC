...
#define GOSSIP_HON "Aufseher, ich bin hier, um im Auftrag der Expedition des Cenarius zu verhandeln."
...
#define GOSSIP_HSTE "Ja... ja, das bin ich."
#define GOSSIP_SSTE "Ja, Älteste. Erzähl mir mehr über dieses Buch."
