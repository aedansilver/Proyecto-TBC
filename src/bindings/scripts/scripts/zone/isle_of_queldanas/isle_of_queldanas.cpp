...
#define GOSSIP_FLY1 "Wo wir gerade von Kämpfen sprechen, ich habe die Order, einen Luftangriff zu starten."
#define GOSSIP_FLY2 "Ich muss die Verstärkung der Dämmerklingen abfangen."
...
#define GOSSIP_UD "Fliegt auf dem Drachenfalken in die Sonnenweiten."
