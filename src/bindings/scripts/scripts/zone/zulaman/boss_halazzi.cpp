...
#define YELL_AGGRO "Auf die Knie und verneigt euch vor den Reißzähnen und der Klaue!"
#define SOUND_AGGRO                    12020
#define YELL_SABER_ONE "Diesen Ort verlasst ihr nicht in einem Stück!"
#define SOUND_SABER_ONE					12024
#define YELL_SABER_TWO "Ich werde euch zerfetzen!"
#define SOUND_SABER_TWO					12023
#define YELL_SPLIT "Ich kämpfe mit wilden Geist!"
#define SOUND_SPLIT                    12021
#define YELL_MERGE "Geist, zurück zu mir!"
#define SOUND_MERGE                    12022
#define YELL_KILL_ONE "Die Macht ist stärker!"
#define SOUND_KILL_ONE                12026
#define YELL_KILL_TWO "Ihr werdet alle versagen!"
#define SOUND_KILL_TWO                12027
#define YELL_DEATH "Chaga... choka'jinn."
#define SOUND_DEATH                    12028
#define YELL_BERSERK "Geht euch die Luft aus?..."
        ...
        if(Phase == PHASE_LYNX || Phase == PHASE_ENRAGE)
        {
            if(SaberlashTimer < diff)
            {
				...
				case 0:
					...
					DoPlaySoundToSet(m_creature, SOUND_SABER_ONE);
					break;
				
				case 1:
					DoYell(YELL_SABER_TWO, LANG_UNIVERSAL, NULL);
					DoPlaySoundToSet(m_creature, SOUND_SABER_TWO);
					break;
				}
