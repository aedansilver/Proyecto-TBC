...
//Speech
#define YELL_TRANSFORM_TO_LYNX "Lernt meine Brüder kennen, Reißzahn und Klaue!"
#define SOUND_TRANSFORM_TO_LYNX 12094

#define YELL_TRANSFORM_TO_BEAR "Sagt Hallo zu Bruder Bär!"
#define SOUND_TRANSFORM_TO_BEAR 12092

#define YELL_TRANSFORM_TO_DRAGONHAWK "Was starrt ihr in die Luft? Der Drachenfalke steht schon vor euch!"
#define SOUND_TRANSFORM_TO_DRAGONHAWK 12095

#define YELL_TRANSFORM_TO_EAGLE "Niemand versteckt sich vor dem Adler!"
#define SOUND_TRANSFORM_TO_EAGLE 12093

#define YELL_KILL_ONE "Da Amani de chuka!"
#define SOUND_KILL_ONE 12098

#define YELL_KILL_TWO "Noch viele werden euer Schicksal erleiden!"
#define SOUND_KILL_TWO 12099

#define YELL_FIRE_BREATH "Das Feuer wird euch den Garr ausmachen!"
#define SOUND_FIRE_BRETH 12096

#define YELL_AGGRO "Keiner kann es mit mir aufnehmen!"
#define SOUND_AGGRO 12091

#define YELL_BERSERK "Ihr seid zu langsam! Ich zu stark!"
#define SOUND_BERSERK 12097

#define YELL_DEATH "Dies ist mein Ende...aber das Imperium der Amani...wird niemals untergehen."
#define SOUND_DEATH 12100

//Still not used, need more info
#define YELL_INTRO "Alle wollen immer von uns nehmen. Jetzt werden wir anfangen uns etwas zurück zu holen. Wer sich uns in den Weg stellt...ersäuft in seinem eigenem Blut! Das Imperium der Amani ist wieder da und sinnt nach Rache. Mit euch werden wir anfangen!"
