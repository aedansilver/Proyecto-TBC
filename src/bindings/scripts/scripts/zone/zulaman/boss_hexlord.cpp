...
#define YELL_AGGRO              "Der Schatten wird euch verschlingen... "
#define SOUND_YELL_AGGRO        12041
#define YELL_SPIRIT_BOLTS       "Eure Seele wird bluten!"
#define SOUND_YELL_SPIRIT_BOLTS 12047
#define YELL_DRAIN_POWER        "Die Dunkelheit wird euch hohlen!"
#define SOUND_YELL_DRAIN_POWER  12046
#define YELL_KILL_ONE           "Aus diesem Alptraum, gibt es kein Erwachen!"
#define SOUND_YELL_KILL_ONE     12043
#define YELL_KILL_TWO           "Azzaga choogo zinn!"
#define SOUND_YELL_KILL_TWO     12044
#define YELL_DEATH              "Das ist nicht... mein Ende..."
...
struct TRINITY_DLL_DECL boss_hex_lord_malacrassAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if(SpiritBolts_Timer < diff)
        {
            ...
            {
                SpiritBoltCast = true;
                m_creature->CastSpell(m_creature, SPELL_SPIRIT_BOLTS, true);
