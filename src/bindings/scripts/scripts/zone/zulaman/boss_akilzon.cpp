...
#define SAY_ONAGGRO "Ich bin der Jäger! Ihr seid die Beute..."
#define SAY_ONDEATH "Ihr könnt.. meinen Geist nicht.. töten!"
#define SAY_ONSLAY1 "Flasche!"
#define SAY_ONSLAY2 "Jammern hilft nich'!"
#define SAY_ONSUMMON "Labt euch, meine Brüder!"
#define SAY_ONENRAGE "Ihr stehlt mir nur meine Zeit man!"
