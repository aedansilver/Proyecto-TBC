...
#define GOSSIP_HL "Ihr müsst schon entschuldigen, Lorax. Verrücktisch sprech ich nicht"

#define GOSSIP_SL1 "Vergebt mir - ich wusste nicht, dass Ihr versteht, was ich sage. Was genau macht Ihr hier draußen?"
#define GOSSIP_SL2 "Ach ja? Vielleicht solltet Ihr mir sagen, was Euch bedrückt"
#define GOSSIP_SL3 "Was für eine Vereinbarung?"
#define GOSSIP_SL4 "Wie hat er denn die Vereinbarung gebrochen?"
#define GOSSIP_SL5 "Vielleicht kann ich Euch ja behilflich sein. Ich schlage Euch einen Handel vor, Satyr: Ich beschaffe Euch diese ungeschmiedete Brustplatte und töte die Bestie, Goraluk Hammerbruch. Und im Gegenzug lehrt Ihr mich wie man die Brustplatte herstellt."
...
#define GOSSIP_HWDM "Ich habe den Behälter von Mau'ri verloren. Was kann ich tun."
