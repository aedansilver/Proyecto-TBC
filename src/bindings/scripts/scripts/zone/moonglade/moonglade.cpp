...
#define GOSSIP_BP1 "Kannst du mir sagen, wo sich Halber Anhänger der Wasserbelastbarkeit befindet?"
#define GOSSIP_BP2 "Ich würde gerne nach Donnerfels fliegen."
...
#define GOSSIP_SF2 "Ich würde gerne nach Rut'theran fliegen."
