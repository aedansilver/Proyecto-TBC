...
void guardAI::Aggro(Unit *who)
{
    if (m_creature->GetEntry() == 15184)
    {
        ...
        {
        case 0:
            DoSay("Probier mein Schwert!", LANG_UNIVERSAL,NULL);
            break;
        case 1:
            DoSay("Erzähl mir nicht das du dass getan hast was ich grade denke.", LANG_UNIVERSAL,NULL);
            break;
        case 2:
            DoSay("Als ob wir nicht genug Probleme hätten, ihr macht noch mehr!", LANG_UNIVERSAL,NULL);
            break;
        }
    }
