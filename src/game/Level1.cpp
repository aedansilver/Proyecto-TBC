...
bool ChatHandler::HandleModifyASpeedCommand(const char* args)
{
    ...
    PSendSysMessage(LANG_YOU_CHANGE_ASPEED, modSpeed, chr->GetName());
    if (needReportToTarget(chr))
        ChatHandler(chr).PSendSysMessage(LANG_YOURS_ASPEED_CHANGED, GetName(), modSpeed);
...
bool ChatHandler::HandleModifySpeedCommand(const char* args)
{
    ...
    PSendSysMessage(LANG_YOU_CHANGE_SPEED, modSpeed, chr->GetName());
    if (needReportToTarget(chr))
        ChatHandler(chr).PSendSysMessage(LANG_YOURS_SPEED_CHANGED, GetName(), modSpeed);
...
bool ChatHandler::HandleModifySwimCommand(const char* args)
{
    ...
    PSendSysMessage(LANG_YOU_CHANGE_SWIM_SPEED, modSpeed, chr->GetName());
    if (needReportToTarget(chr))
        ChatHandler(chr).PSendSysMessage(LANG_YOURS_SWIM_SPEED_CHANGED, GetName(), modSpeed);
...
bool ChatHandler::HandleModifyBWalkCommand(const char* args)
{
    ...
    PSendSysMessage(LANG_YOU_CHANGE_BACK_SPEED, modSpeed, chr->GetName());
    if (needReportToTarget(chr))
        ChatHandler(chr).PSendSysMessage(LANG_YOURS_BACK_SPEED_CHANGED, GetName(), modSpeed);
...
bool ChatHandler::HandleModifyFlyCommand(const char* args)
{
    ...
    PSendSysMessage(LANG_YOU_CHANGE_FLY_SPEED, modSpeed, chr->GetName());
    if (needReportToTarget(chr))
        ChatHandler(chr).PSendSysMessage(LANG_YOURS_FLY_SPEED_CHANGED, GetName(), modSpeed);
