...
bool ChatHandler::HandleServerInfoCommand(const char* /*args*/)
{
	...
	PSendSysMessage("Bugtracker:");
	PSendSysMessage("http://bitbucket.org/lovelol/zuljin-tbc/issues/");
	PSendSysMessage("Danke an:");
	PSendSysMessage("Trinity Core, MaNGOS");
