        ...
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id )
            {
                ...
                case 23645:                                 // Hourglass Sand
                    ...
                    return;
				case 2060:									// Der Tier 4 Setbonus funktioniert nun
				case 10963:
				case 10964:
				case 10965:
				case 25314:
				case 25210:
				case 25213:
					m_caster->RemoveAurasDueToSpell(37565);
					return;
                ...
                */
				...
				case 4537:									// Improved Mana Gems (Serpent-Coil Braid)
				{
					// Mana Surge
        ...
        case SPELLFAMILY_ROGUE:
        {
            ...
            else if(m_spellInfo->SpellFamilyFlags & 0x600000000LL)
            {
                ...
                for(Unit::AuraMap::const_iterator itr = auras.begin(); itr!=auras.end(); ++itr)
                {
                    ...
                    {
                        totalDamagePercentMod *= 1.7f;          // 170% wenn das Ziel Gifte hat um Verstümmeln wegen anderen Bugs zu verstärken
                        break;
                    }
                }
            }
