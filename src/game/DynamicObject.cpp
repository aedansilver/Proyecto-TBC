...
bool DynamicObject::Create( uint32 guidlow, Unit *caster, uint32 spellId, uint32 effIndex, float x, float y, float z, int32 duration, float radius )
{
	...
	switch (spellId)
	{
		case 26573: scale=2;	break;
		case 20116: scale=2;	break;
		case 20922: scale=2;	break;
		case 20923: scale=2;	break;
		case 20924: scale=2;	break;
		case 27173: scale=2;	break;
		case 13810: scale=2;	break;
		case 2120:	scale=2;	break;
		case 2121:	scale=2;	break;
		case 8422:	scale=2;	break;
		case 8423:	scale=2;	break;
		case 10215: scale=2;	break;
		case 10216: scale=2;	break;
		case 27086: scale=2;	break;
	}
    SetEntry(spellId);
